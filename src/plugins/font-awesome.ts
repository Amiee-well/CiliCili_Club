...
library.add(faSolidShop);
library.add(faSolidCrown);
library.add(faSolidOutdent);
library.add(faSolidSearch);
...
library.add(faRegularComments);
library.add(faSolidImages);
library.add(faSolidPodcast);
library.add(faSolidClapperboard);
library.add(faSolidToggleOn);
library.add(faSolidToggleOff);
