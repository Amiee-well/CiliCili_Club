...
import { ROUTE_CHATGLM_PLUS_CONVERSATION, ROUTE_CHATGLM_PLUS_CONVERSATION_NEW } from '@/router';
import { Status } from '@/models';
import Introduction from '@/components/chat/Introduction.vue';
import { isJSONString } from '@/utils/is';
import { chatOperator } from '@/operators';
import Layout from '@/layouts/Chat/chatglm_plus.vue';
...
export default defineComponent({
  ...
  methods: {
    async onGetService() {
      await this.$store.dispatch('chat/getService', CHATGLM_PLUS_SERVICE_ID);
    },
    async onGetApplication() {
      await this.$store.dispatch('chat/getApplication', CHATGLM_PLUS_SERVICE_ID);
    },
    ...
    async onScrollDown() {
      ...
      // 使用 requestAnimationFrame 来减少抖动
    ...
    async onFetchAnswer() {
      ...
      const applications_text = 'ChatGLM-plus';
