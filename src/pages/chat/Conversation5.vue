...
import InputBox from '@/components/chat/InputBox_o1.vue';
import { ElMessage } from 'element-plus';
import { ERROR_CODE_CANCELED, ERROR_CODE_NOT_APPLIED, ERROR_CODE_UNKNOWN } from '@/constants/errorCode';
import { ROUTE_ChatBOT_o1_CONVERSATION, ROUTE_ChatBOT_o1_CONVERSATION_NEW } from '@/router';
import { Status } from '@/models';
import Introduction from '@/components/chat/Introduction.vue';
import Layout from '@/layouts/Chat/chatbox_plus.vue';
...
export default defineComponent({
  ...
  methods: {
    async onGetService() {
      await this.$store.dispatch('chat/getService', CHATBOT_o1_SERVICE_ID);
    },
    async onGetApplication() {
      await this.$store.dispatch('chat/getApplication', CHATBOT_o1_SERVICE_ID);
    },
    ...
    async onFetchAnswer() {
      ...
      const applications_text = 'ChatBOT-o1';
