...
import { ROUTE_CHATBOT_4o_CONVERSATION, ROUTE_CHATBOT_4o_CONVERSATION_NEW } from '@/router';
import { Status } from '@/models';
import Introduction from '@/components/chat/Introduction.vue';
import Layout from '@/layouts/Chat/chatbox.vue';
...
export default defineComponent({
  ...
  methods: {
    async onGetService() {
      await this.$store.dispatch('chat/getService', CHATBOT_4o_SERVICE_ID);
    },
    async onGetApplication() {
      await this.$store.dispatch('chat/getApplication', CHATBOT_4o_SERVICE_ID);
    },
    ...
    async onFetchAnswer() {
      ...
      const applications_text = 'ChatBOT-4o';
