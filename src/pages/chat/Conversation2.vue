...
import { ROUTE_CHATGLM_CONVERSATION, ROUTE_CHATGLM_CONVERSATION_NEW } from '@/router';
import { isJSONString } from '@/utils/is';
import { ElMessage } from 'element-plus';
import { chatOperator } from '@/operators';
import { defineComponent } from 'vue';
import { Status } from '@/models';
import Layout from '@/layouts/Chat/ChatGLM.vue';
...
export default defineComponent({
  ...
  methods: {
    async onGetService() {
      await this.$store.dispatch('chat/getService', CHATGLM_SERVICE_ID);
    },
    async onGetApplication() {
      await this.$store.dispatch('chat/getApplication', CHATGLM_SERVICE_ID);
    },
    ...
    async onFetchAnswer() {
      ...
      const applications_text = 'ChatGLM';
