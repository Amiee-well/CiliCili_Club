...
import { GPT_GRADUATION_THESIS_GENERATION_SERVICE_ID } from '@/constants';
export default defineComponent({
  ...
  methods: {
    ...
    async onGetApplication() {
      await this.$store.dispatch('chat/getApplication', GPT_GRADUATION_THESIS_GENERATION_SERVICE_ID);
    },
  }
});
</script>
