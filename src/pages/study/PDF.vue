...
import { PDF_FORMAT_CONVERSION_SERVICE_ID } from '@/constants';
export default defineComponent({
  ...
  computed: {
    iframeUrl() {
      return `${this.baseInfo?.server_url}`;
    },
    service() {
  ...
  methods: {
    ...
    async onGetApplication() {
      await this.$store.dispatch('chat/getApplication', PDF_FORMAT_CONVERSION_SERVICE_ID);
    },
  }
});
</script>
